      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Button 
              size="lg" 
              className="hover-lift gradient-primary font-semibold px-8 py-3"
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="hover-glow border-primary/50 text-primary hover:bg-primary/10 px-8 py-3"
          ...
          <button 
            ...
            className="animate-bounce hover:animate-none transition-smooth hover:text-primary"
          >
